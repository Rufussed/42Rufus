...
/*   Updated: 2024/05/16 12:17:30 by rlane            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	static t_int_str	**fd_line_buffer;
	char		*line_buffer;
	char		*line;
	char		*read_buffer;

	line_buffer = get_fd_line_buffer(fd, fd_line_buffer);
	...
	if (!put_fd_line_buffer(fd, line_buffer, fd_line_buffer))
		return (NULL);
	return (line);
}
